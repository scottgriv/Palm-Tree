  ...
  <div role="navigation" class="navbar navbar-default navbar-static-top">
    <div class="container">
      <ul class="nav navbar-nav">
        <li class="active"><a href="http://<?php echo $hostIP; ?>/Palm_Tree/customers.php">Customers</a></li>
      </ul>
      <ul class="nav navbar-nav">
        <li><a href="http://<?php echo $hostIP; ?>/Palm_Tree/email.php">Email</a></li>
      </ul>
      <ul class="nav navbar-nav">
        <li><a href="http://<?php echo $hostIP; ?>/Palm_Tree/configure.php">Configure</a></li>
      </ul>
      <?php
